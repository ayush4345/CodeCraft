                                        ...
                                        message.user_id !== user.id ? (
                                            <div className="col-start-1 col-end-8 p-3 rounded-lg" key={index}>
                                                <div className="flex flex-col items-start ml-3">
                                                    ...
                                                    <div className="text-xs text-gray-400">{(message.created_at).substr(0,10)}</div> {/* Display created_at below */}
                                                </div>
                                            </div>
                                        ) : (
                                            <div className="col-start-6 col-end-13 p-3 rounded-lg mr-3" key={index}>
